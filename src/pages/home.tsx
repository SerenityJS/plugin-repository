    ...
    <section className="home-page">
      <div className="page-container">
        ...
        <section className="info">
          ...
          <p>
            This repository is a community-driven collection of plugins for SerenityJS. All plugins
            listed here are contributed by the community and are not officially maintained by the
            SerenityJS team. Please review each plugin's documentation and repository for details on
